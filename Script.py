class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},
Mʏ ɴᴀᴍᴇ ɪs <a href=https://t.me/{}>{}</a>,  ɪ ʜᴀᴠᴇ ᴀ ɢʀᴇᴀᴛ ᴄᴏʟʟᴇᴄᴛɪᴏɴ ᴏғ ᴍᴏᴠɪᴇs ʀᴇᴀᴅʏ ᴛᴏ ᴇɴᴛᴇʀᴛᴀɪɴ ʏᴏᴜ! sɪᴍᴘʟʏ ᴍᴀᴋᴇ ᴍᴇ ᴀɴ ᴀᴅᴍɪɴ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ, ᴀɴᴅ ʏᴏᴜ ᴄᴀɴ sᴛᴀʀᴛ ᴇɴɪᴏʏɪɴɢ ᴛʜᴇᴍ ʀɪɢʜᴛ ᴀᴡᴀʏ! 😍</b>"""
...
sᴛᴇᴘ 𝟸 : ᴍᴀᴋᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ Aɴʏ <a href=https://instantearn.in/ref/dhanushrs>Sʜᴏʀᴛᴇɴᴇʀ Wᴇʙsɪᴛᴇ</a>.

sᴛᴇᴘ 𝟹 : ꜰᴏʟʟᴏᴡ ᴛʜᴇsᴇ <a href=https='t.me/filmyspotupdate/76> ɪɴꜱᴛʀᴜᴄᴛɪᴏɴꜱ </a>Tᴏ ᴄᴏɴɴᴇᴄᴛ sʜᴏʀᴛᴇɴᴇʀ.
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CAPTION = """
<b><a href=https://t.me/+o_VcAI8GRQ8zYzA9>{file_caption}</a>

    🔸Mᴏᴠɪᴇ ᴄʜᴀɴɴᴇʟ : @filmyspotmovie

👉 Cʟɪᴄᴋ ᴏɴ ᴛʜᴇ Fɪʟᴇ ɴᴀᴍᴇ  ᴛᴏ Jᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ʀᴇǫᴜᴇsᴛ ɢʀᴏᴜᴘ👆</b>""" 
...
आप आज सत्यापित नहीं हैं, कृपया सत्यापित करें और अगले सत्यापन के लिए असीमित पहुंच प्राप्त करें...

ನೀವು ಇಂದು ಪರಿಶೀಲಿಸಲಾಗಿಲ್ಲ, ದಯವಿಟ್ಟು ಪರಿಶೀಲಿಸಿ ಮತ್ತು ಮುಂದಿನ ಪರಿಶೀಲನೆಗಾಗಿ ಅನಿಯಮಿತ ಪ್ರವೇಶವನ್ನು ಪಡೆಯಿರಿ..

നിങ്ങൾ ഇന്ന് പരിശോധിച്ചുറപ്പിച്ചിട്ടില്ല, അടുത്ത സ്ഥിരീകരണത്തിനായി പരിശോധിച്ച് പരിധിയില്ലാത്ത ആക്‌സസ് നേടൂ.. |</b>"""
